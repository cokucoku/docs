        ...
        methods: {
            chuli(item) {
                if (this.collapse.accordion) {
                    let temitem=[]
                    if (this.collapse.value == item) {
                        this.collapse.$emit('input',[])
                    } else {
                        temitem.push(item)
                        this.collapse.$emit('input',temitem)
                    }
                } else {
                    if (this.collapse.value.indexOf(item) < 0) {
                        this.collapse.value.push(item)
                    } else {
                        let index = this.collapse.value.indexOf(item)
